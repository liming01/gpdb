...
DATA(insert OID = 7178 ( gp_endpoints_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 1 0 2249 "16" "{16,25,25,23,25,23,23,26,25,25}" "{i,o,o,o,o,o,o,o,o,o}" "{isall,token,cursorname,sessionid,hostname,port,dbid,userid,status,endpointname}" _null_ gp_endpoints_info _null_ _null_ _null_ n m ));
DESCR("mpp endpoints information");

/* gp_endpoints_status_info(OUT token text, OUT databaseid int4, OUT senderpid int4, OUT receiverpid int4, OUT status text, OUT dbid int4, OUT sessionid int4, OUT userid oid, OUT endpointname text) => SETOF record */
DATA(insert OID = 7179 ( gp_endpoints_status_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{25,23,23,23,25,23,23,26,25}" "{o,o,o,o,o,o,o,o,o}" "{token,databaseid,senderpid,receiverpid,status,dbid,sessionid,userid,endpointname}" _null_ gp_endpoints_status_info _null_ _null_ _null_ n a ));
DESCR("endpoints status information");

/* __gp_endpoint_is_ready(cursorname cstring) => bool */
DATA(insert OID = 7180 ( __gp_endpoint_is_ready  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 16 "2275" _null_ _null_ "{cursorname}" _null_ gp_endpoint_is_ready _null_ _null_ _null_ n a ));
DESCR("check whether endpoint is ready");

/* __gp_operate_endpoints_token(IN operation char, IN tokenstr cstring, IN cursorname cstring, OUT success bool) => bool */
DATA(insert OID = 7181 ( __gp_operate_endpoints_token  PGNSP PGUID 12 1 0 0 0 f f f f f f v 3 0 16 "18 2275 2275" "{18,2275,2275,16}" "{i,i,i,o}" "{operation,tokenstr,cursorname,success}" _null_ gp_operate_endpoints_token _null_ _null_ _null_ n a ));
