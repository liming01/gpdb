...
/* gp_endpoints_status_info(OUT token text, OUT databaseid int4, OUT senderpid int4, OUT receiverpid int4, OUT attach_status text, OUT dbid int4, OUT sessionid int4, OUT userid oid) => SETOF record */
DATA(insert OID = 7179 ( gp_endpoints_status_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{25,23,23,23,25,23,23,26}" "{o,o,o,o,o,o,o,o}" "{token,databaseid,senderpid,receiverpid,attach_status,dbid,sessionid,userid}" _null_ gp_endpoints_status_info _null_ _null_ _null_ n a ));
