...
/* gp_endpoints_status_info(OUT token int4, OUT databaseid int4, OUT senderpid int4, OUT receiverpid int4, OUT attached bool) => SETOF record */
DATA(insert OID = 7179 ( gp_endpoints_status_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{23,23,23,23,16}" "{o,o,o,o,o}" "{token,databaseid,senderpid,receiverpid,attached}" _null_ gp_endpoints_status_info _null_ _null_ _null_ n a ));
