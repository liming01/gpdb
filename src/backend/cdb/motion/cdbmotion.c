					...
					int16 srcRoute)
{
	...
	Assert(srcRoute >= 0);
	Assert(srcRoute < mlStates->mneCount);
	...
	if (motNodeEntry->ready_tuple_lists == NULL)
		motNodeEntry->ready_tuple_lists = (ChunkSorterEntry *) palloc0(mlStates->mneCount * sizeof(ChunkSorterEntry));
